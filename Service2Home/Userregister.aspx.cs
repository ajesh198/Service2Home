        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if ((otpref.Text).Equals(otptxt.Text))
                {
                    ...
                    string ins = "insert into  user_reg values(" + regid + ",'" + nametxt.Text + "','" + emailtxt.Text + "','" + phonetxt.Text + "','" + Pintxt.Text + "')";
                    int i = connection.Fun_nonquery(ins);
                    string log = "insert into  login_table values(" + regid + ",'" + emailtxt.Text + "','" + Cpass.Text + "','user','active')";
